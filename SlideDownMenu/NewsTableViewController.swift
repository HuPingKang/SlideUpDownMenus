...
class NewsTableViewController: UITableViewController {
    ...
    @IBAction func toMenu(_ sender: Any) {
        ...
        let vc:MenuTableViewController = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "MenuTableViewController") as! MenuTableViewController
        vc.transitioningDelegate = menuTransitionManager
        menuTransitionManager.delegate = self
        vc.selelctItem = {  item in
